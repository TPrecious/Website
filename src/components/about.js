...
function About() {
    ...
    return (
        <div className="grid grid rows-4 w-full mx-auto text-center text-blue font-BebasNeue text-6xl bg-cyan-200 h-screen ">
            <h2 className="text-2xl grid grid-cols-3 text-center">
                <div className="text-sky-300 cursor-pointer text-4xl" onClick={LoginHandler}>Login</div>
                <div className="text-white font-BebasNeue text-6xl">About</div>
                <div className="text-sky-300 cursor-pointer text-4xl" onClick={SignUpHandler}> Sign Up </div>
            </h2>
            <p className="text-white font-BebasNeue text-1xl text-center">
                This website is for people interested in joing JHB's computer programing class,taught by Ayo Alatishe.
